...
public class GridMaker 
{
    ...
    public static GridElement MakeGridElement(Dictionary<CellElement, DotType> mappedValus, GridElement gridType)
    {
        List<CellElement> targetElements = new List<CellElement>(mappedValus.Keys);
        ...
        for (int i = 0; i < targetElements.Count; i++)
        {
            ...
            DotType dotType = mappedValus[targetElements[i]];
            gridType.AddDot(targetCoor, new DotElement(dotType));
        }
